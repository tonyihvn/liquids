...
<html lang="en">
    ...
    <body>
        ...
        @if (isset($pagename) && $pagename=="Payment")
            <script>
                ...
                let handler = PaystackPop.setup({
                    key: 'pk_live_b452b35469ab5287d8f45bc155f59580f05c14cd', // Replace with your public key
                    ...
                    callback: function(response){
                        ...
                        let subid = '{{$sub->id}}';
                        let payresponse = response.reference;
                        let url = '{{ url('online-payment') }}' + '/' + subid + '/' + payresponse;
